...
class ActivityItem {
  const ActivityItem({required this.activity, required this.time, required this.intensity, required this.category, required this.instructionsList, required this.image});
